          ...
          {tiers.map((tier, index) => (
            <div
              ...
              className={`relative flex flex-col border ${
                tier.recommended
                  ? 'border-[#e7131a] shadow-lg'
                  : 'border-[#e5e5e5]'
              }`}
            >
              {/* Recommended Badge */}
              {tier.recommended && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#e7131a] text-white text-[11px] font-ibm-plex-sans-condensed tracking-wider uppercase px-4 py-1">
                  Most Popular
                </div>
              )}
